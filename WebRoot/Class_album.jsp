...
<script type="text/javascript" src="js/jquery.min-photo.js"></script>
<script type="text/javascript" src="js/cufon-yui-photo.js"></script>
...
<!--               <li ><a  href="albumAction_changeAlbumpageForUser?page.currentPage=<s:property value="#request.page.currentPage+1"/>"></a>-->
<!--          <br></s:if>-->
       ...
       <h2 class="title_name">班级相册</h2>
        <div id="pp_gallery" class="pp_gallery">
			...
			<s:iterator  value="albumList" var="item">
				<div class="album">
				<s:iterator value = "photos"  var="photoset">
						<div class="content">					
								<img src='<s:property value="#photoset.content" />' alt='<s:property value="#photoset.content" />'  style="width:100px; height:100px"/>
								<span><s:property value="#photoset.name" /></span>
							</div>	
					
				</s:iterator>
				<div class="descr"><s:property value="#item.name"/></div>
				</div>
        ...
        <!-- The JavaScript -->
		<script type="text/javascript" src="js/jquery.transform-0.8.0.min-photo.js"></script>
